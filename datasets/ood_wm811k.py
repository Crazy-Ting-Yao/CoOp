...
class OOD_WM811K(DatasetBase):
    """WM811K OOD dataset from HuggingFace.

    Dataset: andyqmongo/IVL_OOD_WM811k (config: 1_shot)
    """

    dataset_dir = "ood_wm811k"
    ...
    def __init__(self, cfg):
        ...
        hf_name = "andyqmongo/IVL_OOD_WM811k"
        num_shots = cfg.DATASET.NUM_SHOTS
        train_split = f"{num_shots}_shot" if num_shots > 1 else "1_shot"

        print(f"Loading OOD_WM811K from HuggingFace ({hf_name}, split={train_split})...")
        ...
        print(
            f"OOD_WM811K: {len(classname_to_label)} classes, "
